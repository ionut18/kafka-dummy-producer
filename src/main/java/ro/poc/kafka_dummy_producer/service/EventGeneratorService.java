package ro.poc.kafka_dummy_producer.service;

import com.github.javafaker.Faker;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import ro.poc.kafka_dummy_producer.model.*;
    ...
    public List<KafkaEvent<DocumentModel>> generateDocuments(final Integer size) {
        return IntStream.range(0, size)
                .mapToObj(i -> {
                    ...
                    final LocalDateTime sentDate = LocalDateTime.ofInstant(faker.date().past(30, TimeUnit.DAYS).toInstant(), ZoneId.systemDefault());
